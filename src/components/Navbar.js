...
//        ="navbar-brand fs-1 fst-italic" to="/ ">SWADGHAR</Link>
//       <button className 
...
//              ="nav-Link" aria-current="page" to=" / "> Home  </Link>
//           </li>
...
//       ="nav-Link" to= "/createuser "> SignUp </Link>
//    </li>
...
//               {/* SignUp Link */}
//               <li className="nav-item">
//                 <Link className="nav-Link mx-1" to="/createuser">
//                   SignUp
//                 </Link>
//               </li>
//             </ul>
...
// ==============================================
// import React from 'react'; // vid 10 complete
...
//               :
//               <div>
//                 <div className="btn" onClick={loadCart}>
//                   <Badge color="secondary" badgeContent={items.length}>
//                     <ShoppingCartIcon />
//                   </Badge>
//                   Cart
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-success position-sticky"
                style={{ boxShadow: "0px 10px 20px black", filter: 'blur(20)', position: "fixed", zIndex: "10", width: "100%" }}>
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic" to="/">Gourmet</Link>
                    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span className="navbar-toggler-icon"></span>
                    </button>
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
